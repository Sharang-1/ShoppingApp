...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        whoMadeIt: json["whoMadeIt"] == null
            ? null
            : Category.fromJson(json["whoMadeIt"]),
        ...
        sleeveLength: json["sleeveLength"] == null
            ? null
            : Category.fromJson(json["sleeveLength"]),
        stitchingType: json["stitchingType"] == null
            ? null
            : Category.fromJson(json["stitchingType"]),
        workOn: json["workOn"] == null
            ? null
            : List<Category>.from(
                json["workOn"].map((x) => Category.fromJson(x))),
        fabricDetails:
            json["fabricDetails"] == null ? null : json["fabricDetails"],
        topsLength: json["topsLength"] == null
            ? null
            : Category.fromJson(json["topsLength"]),
