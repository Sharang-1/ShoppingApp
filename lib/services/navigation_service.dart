...
class NavigationService {
  ...
  Future<dynamic> navigateReplaceTo(String routeName, {dynamic arguments}) => off(routeName, arguments: arguments);

  Future<dynamic> navigateAndRemoveUntil(String routeName,
      {Function predicate, dynamic arguments}) => offAll(routeName,
        predicate: predicate == null ? (route) => false : predicate,
        arguments: arguments);

  //GetX Routing
  Future<T> to<T>(String page, {dynamic arguments, int id}) async =>
      await Get.toNamed<T>(page, arguments: arguments, id: id);

  Future<T> off<T>(String page, {dynamic arguments, int id}) async =>
      await Get.offNamed<T>(page, arguments: arguments, id: id);

  Future<T> offAll<T>(String page,
