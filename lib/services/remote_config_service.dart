...
const String HOMESCREEN_SECTION_2_SUBTITLE_EN =
    'homescreen_section_2_subtitle_en';

const String HOMESCREEN_SECTION_3_TITLE_EN = 'homescreen_section_3_title_en';
const String HOMESCREEN_SECTION_3_SUBTITLE_EN =
    'homescreen_section_3_subtitle_en';

const String HOMESCREEN_SECTION_4_TITLE_EN = 'homescreen_section_4_title_en';
const String HOMESCREEN_SECTION_4_SUBTITLE_EN =
    'homescreen_section_4_subtitle_en';

const String HOMESCREEN_SECTION_5_TITLE_EN = 'homescreen_section_5_title_en';
const String HOMESCREEN_SECTION_5_SUBTITLE_EN =
    'homescreen_section_5_subtitle_en';

const String HOMESCREEN_SECTION_6_TITLE_EN = 'homescreen_section_6_title_en';
const String HOMESCREEN_SECTION_6_SUBTITLE_EN =
    'homescreen_section_6_subtitle_en';

const String HOMESCREEN_SECTION_7_TITLE_EN = 'homescreen_section_7_title_en';
const String HOMESCREEN_SECTION_7_SUBTITLE_EN =
    'homescreen_section_7_subtitle_en';

const String HOMESCREEN_SECTION_8_TITLE_EN = 'homescreen_section_8_title_en';
const String HOMESCREEN_SECTION_8_SUBTITLE_EN =
    'homescreen_section_8_subtitle_en';

const String HOMESCREEN_SECTION_9_TITLE_EN = 'homescreen_section_9_title_en';
const String HOMESCREEN_SECTION_9_SUBTITLE_EN =
    'homescreen_section_9_subtitle_en';
